    ...
    f.ensureModuleRegistered("SignalsConvertNodeToHTMLElement", function () {
      return (function (f, g, h, j) {
        ...
        (function () {
          ...
          function a(a) {
            var b =
              (typeof HTMLElement === "undefined" ? "undefined" : i(HTMLElement)) === "object"
                ? a instanceof HTMLElement
                : a != null && (typeof a === "undefined" ? "undefined" : i(a)) === "object" && a !== null && a.nodeType === 1 && typeof a.nodeName === "string";
            return !b ? null : a;
          }
          k.exports = a;
        })();
      ...
      return (function (g, h, i, j) {
        ...
        (function () {
          ...
          a = a.objectWithFields({
            ...
            eventRulesMappings: a.arrayOf(a.objectWithFields({ ruleGroupId: a.number(), derivedEventName: a.string(), transforms: a.number(), condition: a.string() })),
            customConversionRulesMappings: a.arrayOf(a.objectWithFields({ conversionId: a.number(), conversionRule: a.string() })),
            currencyRateMappings: a.arrayOf(a.objectWithFields({ quoteCurrency: a.string(), rate: a.number() })),
            etldOne: a.string(),
          });
          k.exports = a;
        })();
      ...
      return (function (a, b, c, d) {
        ...
        (function () {
          ...
          function ja(a) {
            ...
            switch (a) {
              ...
              case "releaseSegment":
                var i = c[0];
                if (typeof i !== "string") {
                  M({ invalidParamName: "new_release_segment", invalidParamValue: i, method: "set", params: e, type: "INVALID_FBQ_METHOD_PARAMETER" });
                  break;
                }
                f._releaseSegment = i;
                break;
              case "autoConfig":
                ...
                if (typeof m !== "string") {
                  M({ invalidParamName: "pixel_id", invalidParamValue: m, method: "set", params: e, type: "INVALID_FBQ_METHOD_PARAMETER" });
                  break;
                }
              ...
              case "firstPartyCookies":
                ...
                typeof q === "string"
                  ...
                  : M({ invalidParamName: "pixel_id", invalidParamValue: q, method: "set", params: e, type: "INVALID_FBQ_METHOD_PARAMETER" });
                break;
              case "experiments":
              ...
              case "mobileBridge":
                var u = c[0],
                  v = c[1];
                if (typeof u !== "string") {
                  M({ invalidParamName: "pixel_id", invalidParamValue: u, method: "set", params: e, type: "INVALID_FBQ_METHOD_PARAMETER" });
                  break;
                }
                if (typeof v !== "string") {
                  M({ invalidParamName: "app_id", invalidParamValue: v, method: "set", params: e, type: "INVALID_FBQ_METHOD_PARAMETER" });
                  break;
                }
              ...
              case "trackSingleOnly":
                var D = c[0],
                  ...
                  G = aa(E, ba.fbid());
                if (G == null) {
                  M({ invalidParamName: "pixel_id", invalidParamValue: E, method: "set", params: e, type: "INVALID_FBQ_METHOD_PARAMETER" });
                  break;
                }
                if (F == null) {
                  M({ invalidParamName: "on_or_off", invalidParamValue: D, method: "set", params: e, type: "INVALID_FBQ_METHOD_PARAMETER" });
                  break;
                }
          ...
          function Y(a, b, c) {
            ...
            if (P.call(T, d)) {
              b != null && C(T[d].userData) ? ((T[d].userData = e ? b || {} : {}), W.loadPlugin("identity")) : M({ pixelID: d, type: "DUPLICATE_PIXEL_ID" });
              return;
            }
...
fbq.registerPlugin("global_config", {
  ...
  plugin: function (fbq, instance, config) {
    ...
    fbq.set("experiments", [
      { allocation: 0, code: "u", name: "use_fbc_as_cache_key", passRate: 0 },
